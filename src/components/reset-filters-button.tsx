      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            onClick={handleClick}
            className={cn(
              "group inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md border bg-background text-primary transition-colors hover:bg-primary hover:text-white cursor-pointer disabled:pointer-events-none disabled:opacity-50",
              className,
            )}
            aria-label={tooltip}
          >
