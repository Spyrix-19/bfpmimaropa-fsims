...
import { exportBwcMatrix } from "./bwcMatrixExport";
...
export default function BwcMatrixModal({
  open,
  onOpenChange,
  title,
  totalLabel,
  ...
  const groups = React.useMemo(() => {
    const map = new Map<string, BwcRow[]>();
    filtered.forEach((r) => {
  ...
  const handleExport = () => exportBwcMatrix(groups, fields, totalLabel, title);
