...
export const MOCK_ISSUED_BWC: IssuedBwcRow[] = [
  {
    stationno: "1",
    stationname: "Calapan City Fire Station",
    unitcode: "45201",
    provincename: "Oriental Mindoro",
    cityname: "Calapan City",
    working: 14,
    ber: 3,
  },
  {
    stationno: "2",
    stationname: "Puerto Princesa City Fire Station",
    unitcode: "47301",
  ...
  {
    stationno: "5",
    stationname: "Odiongan Fire Station",
    unitcode: "45903",
  ...
  {
    stationno: "6",
    stationname: "Roxas Fire Station",
    unitcode: "45208",
    provincename: "Oriental Mindoro",
    cityname: "Roxas",
    working: 9,
...
export const totalInspectors = (row: InspectorRow) => row.withTraining + row.withoutTraining;
